...
fig_pos.savefig('results/Plot_Result/position_' + case + '.png', bbox_inches='tight')
fig_quat.savefig('results/Plot_Result/quaternion_' + case + '.png', bbox_inches='tight')
fig_euler.savefig('results/Plot_Result/euler_' + case + '.png', bbox_inches='tight')
fig_bias.savefig('results/Plot_Result/bias_' + case + '.png', bbox_inches='tight')
