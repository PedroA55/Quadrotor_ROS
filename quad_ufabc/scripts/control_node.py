...
def controller_node():
    ...
    infile = open(mydir + '/'+'data/trajectory_4.p', 'rb')
    ...
    while not rospy.is_shutdown():
        ...
        if step < len(traj['x']):
            ...
            psi = quad_ufabc.attitude_euler[2] #Apenas o último ângulo, supondo que psi esteja nessa posição convencional.
            psi_des = 0

            print(pos_real)
            print(vel_real)
            print('os ângulos reais são:')
            print(ang_real)
            ...
            #q0_des_list.append(q_des[0,0]) #Pedro alterou
            #q1_des_list.append(q_des[1,0]) #Pedro alterou
            #q2_des_list.append(q_des[2,0]) #Pedro alterou
